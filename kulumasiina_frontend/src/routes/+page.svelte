    ...
    <div class='row flex-row-reverse'>
      <div class='col-9'>
        <div class='row m-0 g-0'>
          <div class='col-6'>
            <button type='button' class='btn btn-primary form-control' on:click={newExpense}>add expense</button>
          </div>
          <div class='col-6'>
            <button type='button' class='btn btn-primary form-control' on:click={newAllowance}>add mileage allowance</button>  
          </div>
        </div>
